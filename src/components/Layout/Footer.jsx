...
const Footer = () => (
  <footer className="w-full pt-12 pb-4 overflow-hidden text-center text-gray-500 bg-gray-800 border-t-2">
    ...
    <ul className="flex flex-col justify-center text-sm">
      <li>©Georgi 2020</li>
      <li><a className="text-xs font-light text-gray-500" href="https://www.freepik.com/vectors/technology">Technology vector created by stories - www.freepik.com</a></li>
    </ul>
  </footer>
);
